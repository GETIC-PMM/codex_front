    ...
    <div className="grid grid-rows-2 grid-flow-col gap-4">
      ...
      <div className="col-span-2 ...">
        ...
        <div className="flex justify gap-4 mt-4">
          <h1 className="font-bold text-pmmBlue">{titulo}</h1>
        </div>

        <div className="flex justify gap-4 mt-4">
          <img
            className="rounded-full object-cover w-10 h-10 aspect-video"
            src={Ruby}
          />
          <p className="text-pmmGray">{nome_do_autor}</p>
          <p className="text-pmmGray">
            {dayjs(data_publicacao).format("DD/MM/YYYY")}
          </p>
        </div>
      </div>
